...
import dramas from "../data/drama.js"; // your marvel.js data
...
const Drama = () => {
  ...
  return (
    <div className="p-6 flex flex-col text-white items-center bg-[#1f2b61]">
      ...
      {/* main headind */}
      <h1 className="font-bold text-start m-3 p-2 text-2xl">Popular Drama</h1>
        ...
        {selected && (
          <div className="space-y-3 tracking-normal">
            <p className="font-bold text-black">
              <strong>Drama:</strong> {selected.title}
            </p>
            <img
